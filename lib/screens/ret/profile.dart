...
class SellerProfile extends StatelessWidget {
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              'On An About Budget Related Announcements: Stay informed of changes that may impact your business on Leez.',
  ...
  Widget _buildManagementOption(String title, {String? trailing}) {
    return ListTile(
      ...
      title: Text(title),
      trailing: trailing != null ? Text(trailing, style: const TextStyle(color: Color.fromARGB(255, 0, 0, 0))) : null,
      onTap: () {},
    );
  }
}
